...
import Migration0041 from "./Migrations/041_ProjectionThreadSessionAdapterCapabilities.ts";
import Migration0042 from "./Migrations/042_ProjectionTurnsTerminalAbortCheckpoint.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadSessionAdapterCapabilities", Migration0041],
  [42, "ProjectionTurnsTerminalAbortCheckpoint", Migration0042],
] as const;
