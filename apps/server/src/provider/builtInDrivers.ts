 ...
 */
import { GjcDriver, type GjcDriverEnv } from "./Drivers/GjcDriver.ts";
 ...
 */
export type BuiltInDriversEnv = GjcDriverEnv;
 ...
 */
export const BUILT_IN_DRIVERS: ReadonlyArray<AnyProviderDriver<BuiltInDriversEnv>> = [GjcDriver];
